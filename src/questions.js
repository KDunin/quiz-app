export const QUESTIONS = [{
  ...
  "answers":  [
    "Standard protokołu komunikacyjnego używanego w sieciach komputerowych",
  ...
  "answers":  [
    ...
    "User Information Details - informacje szczegółowe o użytkowniku",
  ...
  "question": "Serwer to:",
  "answers":  [
    "Proces świadczący usługi na rzecz innych procesów, zazwyczaj uruchomionych na innych komputerach w sieci",
    "Standard protokołu komunikacyjnego używanego w sieciach komputerowych",
  ...
  "answers":  [
    "Zawartość pliku file1 zostanie skopiowana do pliku file2",
    "Jeśli plik file1 nie istnieje, to zostanie utworzony",
